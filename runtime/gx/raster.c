                         ...
                         const MgsGxVertex* b, const MgsGxVertex* c)
{
     ...
     * one; the binding cannot change within a primitive. */
    {
        ...
        if (tex_enabled) {
            ...
            /* THE DRAW LOG: four stores, and the roughness read from the
             * texture rather than measured here.
             *
             * This used to scan the whole bound texture at this point, on
